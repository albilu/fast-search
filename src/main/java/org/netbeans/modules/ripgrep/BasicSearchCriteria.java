...
public final class BasicSearchCriteria {
    ...
    private static final Logger LOG = Logger.getLogger(
            "org.netbeans.modules.ripgrep.BasicSearchCriteria"); // NOI18N
    ...
    /**
     * Holds a {@code DataObject} that will be used to create a
     * {@code TextDetail}. It should be set to {@code null} immediately after
     ...
     * regexp pattern, is determined by the current <em>regexp</em> setting (see
     * {@link #setRegexp(boolean)}).
     *
     ...
     * validity. In case of success, the compiled pattern is stored to
     * {@link #textPattern}, otherwise the field is set to {@code null}.
     *
     * <p>
     * Actually, this method defines a pattern used in searching, i.e. it
     ...
     * same as in the implementation of the Find action (i.e in the method
     * {@code getFinder} of the class
