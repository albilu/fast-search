...
class ResultViewPanel extends JPanel implements Lookup.Provider {
    ...
    @StaticResource
    private static final String STOP_ICON = "org/netbeans/modules/ripgrep/res/stop.png"; // NOI18N
    @StaticResource
    private static final String INFO_ICON = "org/netbeans/modules/ripgrep/res/info.png"; // NOI18N
