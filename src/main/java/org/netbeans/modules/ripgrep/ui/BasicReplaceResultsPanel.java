...
public class BasicReplaceResultsPanel extends BasicAbstractResultsPanel {
    ...
    private void replace() {
        //TODO implement sd replace wrapper
        ReplaceTask taskReplace = new ReplaceTask(resultModel.getMatchingObjects(), this);
    ...
    public void showFinishedInfo() {
        ...
        an.setIconBaseWithExtension(
                "org/netbeans/modules/ripgrep/res/info.png");            //NOI18N
