...
/**
 * Panel which displays search results in explorer like manner. This panel is a
 * singleton.
 *
 ...
 * @author kaktus
 */
@TopComponent.Description(preferredID = ResultView.ID, persistenceType = TopComponent.PERSISTENCE_ALWAYS, iconBase = "org/netbeans/modules/ripgrep/res/find.gif")
@TopComponent.Registration(mode = "output", position = 1900, openAtStartup = false)
@ActionID(id = "org.netbeans.modules.ripgrep.ResultViewOpenAction", category = "Window")
...
public final class ResultView extends TopComponent {
     ...
     */
    static final String ID = "fast-search-results";                  //NOI18N
    ...
    public ResultView() {
        ...
        setName("Fast Search Results");                                      //NOI18N
     ...
     * accessible via <code>Class.getDeclaredMethod(String, Class[])</code>. It
     * is used in <code>Manager</code>.
     */
    void closeResults() {
        close();
    }
    ...
    /**
     * Displays a message informing about the task which blocks the search from
     * being started. The search may also be blocked by a not yet finished
